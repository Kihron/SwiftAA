...
class TrimAdvancement: Advancement {
    ...
    init(id: String, category: Category, key: String, name: String, shortName: String? = nil, icon: String, frameStyle: String, criteria: [Criterion], completed: Bool) {
        super.init(id: id, category: category, key: key, name: name, shortName: shortName, icon: icon, frameStyle: frameStyle, criteria: criteria, completed: completed)
    }
