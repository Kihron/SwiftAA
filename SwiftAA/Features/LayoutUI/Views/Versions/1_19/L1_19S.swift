                    ...
                    VStack(spacing: 0) {
                        HStack(spacing: 0) {
                            ...
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .husbandry, start: "minecraft:husbandry/froglights"), columnCount: 1)
                                .frame(width: 74)
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, end: "minecraft:adventure/spyglass_at_dragon"), columnCount: 6)
                                .frame(width: 437)
                        ...
                        HStack(spacing: 0) {
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .end, start: "minecraft:end/kill_dragon"), columnCount: 4)
                                .frame(width: 276)
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .husbandry, end: "minecraft:husbandry/allay_deliver_cake_to_note_block"), columnCount: 10)
                                .frame(width: 688)
