...
struct L1_20M: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 0) {
                AdvPanelView(indicators: .constant(advancementManager.minimalisticAdvancements), columnCount: 11, isMinimal: true)
                    .frame(width: 814)
                
                AdvPanelView(indicators: metricManager.getSpecificStats(types: [.trident, .snifferEggs, .shells, .goldBlocks, .witherSkulls, .beehives, .ancientDebris]), columnCount: 2, isStat: true)
                    .frame(width: 148)
