...
struct L1_21V: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 0) {
                AdvPanelView(indicators: .constant(advancementManager.minimalisticAdvancements), columnCount: 6, isMinimal: true)
                    .frame(width: 400)
                ...
                VStack(spacing: 0) {
                    ...
                    HStack(spacing: 0) {
                        GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/complete_catalogue"), rowCount: 7, goal: L10n.Goal.cats, isMinimal: true)
                            .frame(width: 155)
                        
                        GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/whole_pack"), rowCount: 7, goal: L10n.Goal.dogs, isMinimal: true)
                            .frame(width: 155)
                    }
                    .frame(height: 185)
                    
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/bred_all_animals"), rowCount: 7, goal: L10n.Goal.animalsBred, isMinimal: true)
                        .frame(height: 180)
                }
                .frame(width: 310)
            }
            ...
            HStack(spacing: 0) {
                GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:adventure/adventuring_time"), rowCount: 14, goal: L10n.Goal.biomesVisited, isMinimal: true)
                    .frame(width: 514)
                VStack(spacing: 0) {
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:adventure/trim_with_all_exclusive_armor_patterns"), rowCount: 4, goal: L10n.Goal.trims, isMinimal: true)
                        .frame(height: 140)
