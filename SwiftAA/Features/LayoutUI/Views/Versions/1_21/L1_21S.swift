            ...
            VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        HStack(spacing: 0) {
                            ...
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .nether), columnCount: 8)
                                .frame(width: 558)
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, start: "minecraft:adventure/root", end: "minecraft:adventure/trim_with_all_exclusive_armor_patterns"), columnCount: 7)
                                .frame(width: 480)
                            AdvPanelView(indicators: metricManager.getSpecificStats(types: [.trident, .shells, .snifferEggs]), columnCount: 1, isStat: true)
                                .frame(width: 75)
                        }
                        
                        HStack(spacing: 0) {
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .end, start: "minecraft:end/root"), columnCount: 3)
                                .frame(width: 212)
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .husbandry, start: "minecraft:husbandry/plant_seed", end: "minecraft:husbandry/obtain_netherite_hoe"), columnCount: 8)
                                .frame(width: 548)
                            ...
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, start: "minecraft:adventure/spyglass_at_parrot", end: "minecraft:adventure/spyglass_at_dragon"), columnCount: 1)
                                .frame(width: 74)
                            AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, start: "minecraft:adventure/avoid_vibration"), columnCount: 7)
                                .frame(width: 480)
                            AdvPanelView(indicators: metricManager.getSpecificStats(types: [.witherSkulls, .goldBlocks, .heavyCore]), columnCount: 1, isStat: true)
                                .frame(width: 75)
                        }
                    }
                ...
                HStack(spacing: 0) {
                    ...
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/balanced_diet"), rowCount: 16, goal: L10n.Goal.foodsEaten)
                        .frame(width: 315)
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/bred_all_animals"), rowCount: 16, goal: L10n.Goal.animalsBred, hidePercentage: true)
                        .frame(width: 168)
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/complete_catalogue"), rowCount: 16, goal: "", hidePercentage: true)
                        .frame(width: 90)
                    GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/whole_pack"), rowCount: 16, goal: L10n.Goal.dogs, hidePercentage: true)
                        .frame(width: 90)
