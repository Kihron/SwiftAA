        ...
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 0) {
                VStack(spacing: 0) {
                    ...
                    AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .end, start: "minecraft:end/kill_dragon"), columnCount: 5)
                }
                .frame(width: 350)
                
                VStack(spacing: 0) {
                    AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .nether), columnCount: 8)
                    AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .husbandry), columnCount: 8)
                }
                .frame(width: 540)
                
                VStack(spacing: 0) {
                    AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, end: "minecraft:adventure/sniper_duel"), columnCount: 4)
                    AdvPanelView(indicators: advancementManager.getCategoryAdvancements(category: .adventure, start: "minecraft:adventure/voluntary_exile"), columnCount: 4)
                }
                .frame(width: 270)
            ...
            HStack(spacing: 0) {
                ...
                GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/bred_all_animals"), rowCount: 16, goal: L10n.Goal.animalsBred)
                    .frame(width: 188)
                GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:husbandry/complete_catalogue"), rowCount: 16, goal: L10n.Goal.cats, hidePercentage: true)
                    .frame(width: 131)
                GoalPanelView(advancement: advancementManager.getGoalAdvancement(id: "minecraft:nether/explore_nether"), rowCount: 16, goal: L10n.Goal.nether)
                    .frame(width: 140)
            }
